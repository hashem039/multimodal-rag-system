...
create:
- A new directory feature-name under specs for this feature work
- In there:
...
Important: You must use your AskUserQestion tool, grouped on these 3, before writing to disk.
